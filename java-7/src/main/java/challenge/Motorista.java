...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if(idade < 0) throw new  IllegalArgumentException("Idade nao pode ser negativa");
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            if(pontos < 0) throw new IllegalArgumentException("Pontos nao podem ser negativos");
            this.pontos = pontos;
            return this;
        }
        ...
        public void checkConditions(String name, String habilitacao){
            if(this.habilitacao.isEmpty() || this.nome.isEmpty() ) throw new NullPointerException("Motorista sem habilitacao");
        }

        public Motorista build() {
            checkConditions(this.nome, this.habilitacao);
